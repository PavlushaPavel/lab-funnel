...
/**
 * Ниша-пример выводится из NICHE_OF (src/content/niches.ts) — единый источник правды.
 * Импорт намеренно идёт из niches.ts, а не из mechanics.ts: последний — 883 строки данных
 * всех шести механик, лениво загружаемых вместе со своими экранами, а specializations.ts
 * нужен рано (фаза ЗНАЮ) и не должен тащить их за собой в стартовый чанк.
